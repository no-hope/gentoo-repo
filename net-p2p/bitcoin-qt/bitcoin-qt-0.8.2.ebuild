...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/bitcoin-qt/bitcoin-qt-0.8.1.ebuild,v 1.5 2013/05/14 11:45:50 ago Exp $
...
src_prepare() {
	...
	filt="bitcoin_\\(${filt:2}\\)"
	sed "/${filt}\\.qm/d" -i 'qt/bitcoin.qrc'
	sed "/${filt}\\.ts/d" -i 'qt/bitcoin.qrc'
